# -*- coding: utf-8 -*-
#
# easysearch documentation build configuration file, created by
...
latex_documents = [
  ('index', 'easysearch.tex', u'easysearch Documentation',
...
man_pages = [
    ('index', 'templateclass', u'easysearch Documentation',
     [u'Camptocamp SA'], 1)
]
